...
const features = [
  {
    ...
    description: "Discover trusted local businesses, from plumbers to bakers, all verified for your peace of mind.",
    link: "/vendors",
  ...
  },
  {
    ...
    description: "Join community discussions, share ideas, and stay informed about local events and initiatives.",
    link: "/forums",
  ...
  },
  {
    ...
    description: "Built on a foundation of trust, with robust privacy controls and adherence to WCAG 2.1 AA standards.",
    link: "/privacy",
    linkText: "Learn More",
  },
  {
    ...
    description: "Quickly get the gist of long discussions and event details with our helpful AI summarization tool.",
    link: "/forums",
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-muted-foreground max-w-3xl mx-auto">
              We provide the tools to build a vibrant, safe, and supportive
              local community.
            </p>
          </div>
