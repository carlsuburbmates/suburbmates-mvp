...
export default function RefundRequestPage() {
  ...
  async function onSubmit(values: z.infer<typeof refundRequestSchema>) {
    ...
    try {
      ...
      const refundRequestsRef = collection(
        firestore,
        `vendors/${vendorId}/refund_requests`
      )
      const newRequestRef = await addDocumentNonBlocking(
        refundRequestsRef,
        refundRequestData
      )
      ...
      if (vendorSnap.exists()) {
        ...
        if (newRequestRef) {
          await sendNewRefundRequestNotification(vendor, order, {
            id: newRequestRef.id,
            ...refundRequestData,
          })
        }
      ...
      toast({
        ...
        description:
          'The vendor has been notified. You will receive an update via email.',
      })
    ...
    return (
      <div className="text-center">
        ...
        <p className="text-muted-foreground mt-2">
          We couldn't find the order you're trying to request a refund for.
        </p>
        <Button
    ...
    <div className="flex justify-center">
      <Card className="w-full max-w-2xl bg-card/80 backdrop-blur-lg shadow-2xl">
        <CardHeader>
          ...
          <CardDescription>
            Request a refund for your order of{' '}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      Your feedback is important. The vendor will be notified of
                      your request.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      If the item is damaged or not as described, please provide
                      a photo.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
