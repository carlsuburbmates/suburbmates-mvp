  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          A dispute is opened when a customer questions a payment with their
          bank. You must respond with evidence in your Stripe Dashboard to
          resolve them. Disputes are automatically summarized by AI.
        </CardDescription>
      </CardHeader>
      <CardContent>
        {isLoading && (
              ...
              {disputes.map((dispute) => (
                ...
                >
                  <TableCell className="font-medium text-sm">
                    {dispute.disputeSummary?.summary ||
