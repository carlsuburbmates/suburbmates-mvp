    ...
    return (
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Get discovered by the local community by listing your business in
            the directory.
          </CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <div className="grid gap-8">
        ...
        {!vendor.paymentsEnabled && (
          <Card className="bg-amber-50 border-amber-200">
            <CardHeader>
              <CardTitle className="font-headline text-amber-900">
                Enable Sales on the Marketplace
              </CardTitle>
              <CardDescription className="text-amber-800">
                To sell products and services, you need to connect a Stripe
                account. This allows you to receive secure payments directly.
              </CardDescription>
            </CardHeader>
            <CardContent>
              {!vendor.stripeAccountId ? (
                ...
                <div className="flex items-center p-4 rounded-lg bg-blue-100 border border-blue-200 text-blue-900">
                  ...
                  <div>
                    ...
                    <p className="text-sm">
                      Your Stripe account is connected but pending final
                      approval. An admin will enable payments for your account
                      shortly.
                    </p>
                  </div>
                </div>
          ...
          <Card>
            <CardHeader className="flex-row items-center justify-between">
              <div className="space-y-1">
                ...
                <CardDescription>
                  Manage your products and services offered on the marketplace.
                </CardDescription>
              </div>
              ...
              {hasReachedListingLimit && (
                <Alert className="mb-6 border-primary/50 text-primary-foreground bg-primary/10">
                  ...
                  <AlertDescription className="text-primary/90">
                    Your current plan includes one active listing. To add more
                    products and services, please upgrade to our Premium Tier.
                  </AlertDescription>
                ...
                {listings?.map((listing) => (
                  <Card key={listing.id} className="flex flex-col">
                    ...
                    <CardContent className="pt-4 flex-grow">
                      ...
                      <p className="text-muted-foreground text-sm flex-grow line-clamp-3 mt-2">
                        {listing.description}
                      </p>
                    ...
                    <CardFooter className="flex gap-2">
                      <Button variant="outline" size="sm" asChild>
                        <Link
                          href={`/dashboard/vendor/edit-listing/${listing.id}`}
                        >
                          <Edit className="mr-2 h-4 w-4" />
                          Edit
                        </Link>
