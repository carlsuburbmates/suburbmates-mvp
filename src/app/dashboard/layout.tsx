...
export default function DashboardLayout({
  ...
  const { data: vendor, isLoading: isVendorDocLoading } =
    useDoc<Vendor>(vendorRef)

  const isLoading =
    isUserLoading || isClaimLoading || (vendor && isVendorDocLoading)
  ...
  const getDescription = () => {
    ...
    if (isBusiness)
      return 'Manage your business directory listing and complete onboarding to become a vendor.'
